...
public class BookStore {
	...
	/** Crear un método que cargue el fichero de texto de tipo CSV 
	 * separados los campos por puntos y coma y añadirlos al final de un fichero llamado de acceso aleatorio BIBLIO.BIN*/
	...
	/**
	 * Crear un método que reciba un objeto Book y lo añada al fichero “BIBLIO.BIN”,
	 *  devolverá true si se realiza de forma exitosa y false en caso contrario.
	 */
	...
	/**
	 * 4.Crear un método que reciba un id y devuelva un objeto Book del fichero  “BIBLIO.BIN”
	 */
	...
	/**
	 * 5.Crear un método que reciba un id de un libro y lo elimine del fichero "BIBLIO.BIN" , 
	 * devolverá true si se realiza de forma exitosa y false en caso contrario. 
	 */
