public class Book {
	/**
	 * Book_Id int, title String 20, FK_Author int (Table Author) , Year int, FK_Publisher int (Table Publisher), stock int.
	 */
	...
	public void ShowBook (){
		System.out.println("Id: " + Id + " |  " + "Titulo: "+ Titulo + " |  " + "Fk_Autor:" + Fk_Autor
				+ " |  " + "Fk_Editorial:" + Fk_Editorial + " |  "+ "Año:" + Anio + " |  " + "Stock:"	+ Stock);
	}
